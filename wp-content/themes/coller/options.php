...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Custom Code in Header', 'coller'),
		'desc' => __('Insert scripts or code before the closing &lt;/head&gt; tag in the document source:', 'coller'),
		'id' => 'headcode1',
		'std' => '',
		'type' => 'textarea');
	...
	$options[] = array(
		'desc' => __('We are Offering a 30% Discount to all our customers till 10th January, 2014. Use Coupon code <strong>BYEBYE2013</strong> to claim the discount. <a href="http://rohitink.com/product/coller-pro" target="_blank">Upgrade to Pro</a> and take your site to the next level.'),
		'std' => '',
		'type' => 'info');
