...
require_once(dirname(dirname(__FILE__)) . '/wp-load.php');//В этом файле причина отправки на XAMPP(index.php)
...
elseif (WP_USER_ADMIN)
	...
	require(ABSPATH . 'wp-admin/menu.php');//здесь подключается сообщение: "Вы не имеете достаточно прав для доступа к дан..
